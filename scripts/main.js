...
var cards = [{ name: 'The Fool',
  number: '0',
  meanings: ['new beginnings and experiences', 'flexibility and openness to change', 'taking risks and trusting yourself', 'travel and adventure'] }, { name: 'The Magician',
  number: 'I',
  meanings: ['focusing on options and opportunities', 'pursue a new direction with willpower and ambition', 'clarity of mind and all mental activity', 'communication', 'making things happen'] }, { name: 'The High Priestess',
  number: 'II',
  meanings: ['developing your intuition', 'trusting your instincts', 'being self-nurturing', 'and patient as situations will be resolved at the right time'] }, { name: 'The Empress',
  number: 'III',
  meanings: ['motherhood or maternal instincts', 'nurturing others', 'make use of and develop your creativity', 'fruitfulness, abundance', 'love of nature and beauty', 'settling down, security and stability'] }, { name: 'The Emperor',
  number: 'IV',
  meanings: ['important decisions need to be made, perhaps not easy ones', 'being assertive', 'leading the way', 'taking charge', 'establishing security', 'finishing projects that you’ve started'] }, { name: 'The Hierophant',
  number: 'V',
  meanings: ['teaching or studying', 'social interaction on a professional or ethical level', 'working within hierarchies', 'intellectual development', 'spiritual guidance'] }, { name: 'The Lovers',
  number: 'VI',
  meanings: ['relationships (partner, family, friends, colleagues)', 'major choices regarding relationship', 'taking responsibility', 'following your heart without losing your head'] }, { name: 'The Chariot',
  number: 'VII',
  meanings: ['setting targets and goals', 'proving yourself', 'taking control with skill and determination', 'overcoming struggle and tension', 'persevering despite difficulties'] }, { name: 'Strength',
  number: 'VIII',
  meanings: ['courage and endurance in times of adversity', 'controlling anger or jealousy', 'strong passions and desires', 'letting situations unfold without forcing them', 'being assertive and standing up for yourself'] }, { name: 'The Hermit',
  number: 'IX',
  meanings: ['solitude', 'introspection', 'contemplating', 'reviewing your options', 'prudence', 'taking time out', 'looking after your health'] }, { name: 'The Wheel of Fortune',
  number: 'X',
  meanings: ['luck and fate', 'completion of one cycle and beginning of another', 'major change', 'dealing with unforeseen events'] }, { name: 'Justice',
  number: 'XI',
  meanings: ['balance and harmony', 'fairness', 'legal or financial issues', 'integrity', 'partnerships'] }, { name: 'The Hanged Man',
  number: 'XII',
  meanings: ['gaining a new perspective', 'making a sacrifice', 'giving something up', 'stagnation'] }, { name: 'Death',
  number: 'XIII',
  meanings: ['letting go of something old to make way for something new', 'transformation', 'regeneration', 'dealing with emotional pain'] }, { name: 'Temperance',
  number: 'XIV',
  meanings: ['making concessions, compromises', 'creating a healthy balance', 'relinquish excessive lifestyle', 'give and take'] }, { name: 'The Devil',
  number: 'XV',
  meanings: ['dependency', 'manipulation', 'reluctant to change', 'putting up with something negative', 'creating unrest', 'Strong sexuality'] }, { name: 'The Tower',
  number: 'XVI',
  meanings: ['sudden change', 'shock to the system; can be positive or negative', 'anger and pain', 'starting from scratch', 'revelation or epiphany completely altering your attitude or opinion of something'] }, { name: 'The Star',
  number: 'XVII',
  meanings: ['period of hope and healing', 'optimism for the future', 'back to basics and nature', 'sustainability'] }, { name: 'The Moon',
  number: 'XVIII',
  meanings: ['dealing with changing moods', 'reflections and vivid dreams', 'acknowledge and work with your inner rhythm and cycles', 'being drawn by an unknown desire'] }, { name: 'The Sun',
  number: 'XIX',
  meanings: ['achievement of major goal', 'birth or marriage', 'self-worth, confidence and contentment', 'strong creative and passionate phase'] }, { name: 'Judgement',
  number: 'XX',
  meanings: ['dealing with criticism', 'evaluation from yourself and others', 'worldview and understanding', 'transitions', 'taking stock', 'review', ' analysis'] }, { name: 'The World',
  number: 'XXI',
  meanings: ['sense of endless potential', 'realising and accepting your limitations', 'finding your place within a structure or in society', 'being established', 'concluding an ongoing situation', 'settling down'] }];
...
function sumArrayToNumber(array) {
  var result = 0;
...
function myNumber(month, day, year) {
  var number = sumArrayToNumber(sortString(String(month)).concat(sortString(String(day))).concat(sortString(String(year))));

  if (number === 22) {
    number = 0;
    return number;
  } else if (number > 22) {
    number = sumArrayToNumber(sortString(String(number)));
    return number;
  } else {
    return number;
  }
...
var Header = React.createClass({
  ...
  render: function render() {
    return React.createElement(
      "header",
      null,
      React.createElement("img", { className: "logo", src: "/assets/logo.svg" }),
      React.createElement(
        "h1",
        null,
        "Tarot Calculator"
      ),
      React.createElement("input", { className: "menu-btn", type: "checkbox", id: "menu" }),
      React.createElement(
        "label",
        { className: "menu-icon", htmlFor: "menu" },
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "a",
            { href: "https://github.com/stklauz/tarot-calculator" },
            React.createElement("img", { className: "social-icon", src: "/assets/git.svg" })
          )
        )
      )
    );
...
var Form = function (_React$Component) {
  ...
  _createClass(Form, [{
    ...
    value: function handleSubmit(event) {
      ...
      this.props.myCard(month, day, year, range);
    ...
    key: "optionNumList",
    value: function optionNumList(min, max, descent) {
      if (descent) {
        var listNum = this.props.listNumMaxMin(min, max);
      } else {
        var listNum = this.props.listNumMinMax(min, max);
      }

      return listNum.map(function (i) {
        return React.createElement(
          "option",
          { key: i, value: i },
          i
    ...
    value: function render() {
      var listMonths = this.props.listMonths(),
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "select",
              { id: "month",
                defaultValue: "1", value: this.state["month"],
                onChange: this.handleChange },
              listMonths.map(function (month, i) {
                return React.createElement(
                  "option",
                  { key: i, value: i + 1 },
                  month
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              { id: "year",
                ...
                onChange: this.handleChange },
              this.optionNumList(currentYear - 100, currentYear, true)
            )
          ),
          React.createElement(
            "div",
            ...
            React.createElement("input", { id: "range", type: "range", min: "0", max: "100", step: "5", defaultValue: this.state['range'],
              onChange: this.handleChange })
          ),
...
var Results = React.createClass({
  ...
  render: function render() {
    var numbers = this.props.myNumber;
    return React.createElement(
      "section",
      { className: "results" },
      numbers.map(function (num, i) {
        ...
        return React.createElement(
          "div",
          { className: "results__card-container" },
          React.createElement(
            "a",
            { key: i, href: "#/", className: "card" },
            React.createElement(
              "div",
              ...
              React.createElement("div", { className: "card__img" }),
              React.createElement(
                "div",
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                " represents",
                cards[number].meanings.map(function (meaning, i) {
                  if (i == 0) {
                    return " " + meaning;
                  } else {
                    return ", " + meaning;
...
var App = React.createClass({
  ...
  listNumMinMax: function listNumMinMax(begin, end) {
    var list = [];
  ...
  listNumMaxMin: function listNumMaxMin(begin, end) {
    var list = [];
  ...
  // FUNCTIONS
  // --- fundamental ---
  myCard: function myCard(month, day, year, range) {
    var list = [],
        realRange = Number(range) + Number(year);
    for (var i = year; i < realRange; i++) {
      var number = myNumber(day, month, i);
      list.push([number, i]);
    }
    this.setState({ myNumber: list });
  },
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(Form, {
          listNumMaxMin: this.listNumMaxMin,
          listNumMinMax: this.listNumMinMax,
          listMonths: this.listMonths, myCard: this.myCard }),
        React.createElement(Results, { myNumber: this.state.myNumber })
      )
    );
  }
});
