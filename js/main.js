    ...
    _createClass(Antonio, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                "section",
                { className: "section--before row" },
                React.createElement("img", { src: "/assets/img/title_before_main.svg", alt: "Marta e Diogo" }),
                React.createElement(
                    "form",
                ...
                React.createElement("img", { src: "/assets/img/title_before_second.svg", alt: "Marta e Diogo" })
            );
        }
    }]);
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    "header",
                    null,
                    React.createElement("input", { type: "checkbox", id: "menu" }),
                    React.createElement(
                        "label",
                        { htmlFor: "menu" },
                        React.createElement("i", { className: "fa fa-bars fa-2x", "aria-hidden": "true" })
                    ),
                    React.createElement(
                        "nav",
                        null,
                ...
                React.createElement(
                    "section",
                    { id: "fofos", className: "section--before" },
                    React.createElement("img", { src: "/assets/img/title_main.svg" })
                ),
                React.createElement(
                    "article",
                    { className: "container" },
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "p",
                                null,
                                "O grande dia est\xE1 a chegar! Se est\xE1s a ler esta mensagem significa que \xE9s importante para n\xF3s e queremos muito contar com a tua presen\xE7a  no nosso casamento, dia ",
                                React.createElement(
                                    "strong",
                                    null,
                            ...
                            React.createElement(
                                "p",
                                null,
                                "A cerim\xF3nia decorrer\xE1 na ",
                                React.createElement(
                                    "strong",
                                    null,
                                    "Igreja da Parede, \xE0s 11h"
                                ),
                                ", e a festa continuar\xE1 na ",
                                React.createElement(
                                    "strong",
                                    null,
                                    "Quinta da Murta, em Bucelas"
                                ),
                                ". Convidamos-te a explorar o nosso site para descobrires mais sobre este dia!"
                            )
                        )
                    ),
